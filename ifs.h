...
struct Bitword {
  ...
  int continuance_of_prefix_last_letter(int prefix_n) const;
...
struct BoundarySpace {
  ...
  std::vector<Bitword> contracted_boundary;
...
//  os << "Boundary space with " << b.boundary.size() << " boundary elements\n";
//  os << "Lam has " << b.lam.size() << " leaves\n";
//  os << "Cut depth: " << b.cut_depth << " lam depth: " << b.lam_depth << "\n";
//  return os;
//}
